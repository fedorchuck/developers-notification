...
public class JsonDeserializer {
    ...
    private List<Object> readArray(String json, Type type) throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
