...
* (Optional) Add your developer id, name and email for POM.XML at [CONTRIBUTORS.md](https://github.com/fedorchuck/developers-notification/blob/master/CONTRIBUTORS.md)
